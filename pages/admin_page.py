...
class AdminPage:
    def __init__(self, driver):
        ...
        # self.edit_product_link = (By.XPATH, "//a[@href='/admin/products/672b3e7a77265b006ad1a76a']/button")
        # self.edit_product_link = (By.XPATH, "//a[@href='/admin/products/672b3e7a77265b006ad1a76a']")
