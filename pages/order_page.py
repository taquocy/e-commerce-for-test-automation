...
class OrderProductPage:
    def __init__(self, driver):
        ...
        self.addToBasket_button = (
            By.CSS_SELECTOR,
            ".chakra-button.css-4nu9hl:first-of-type",
        )
    ...
    def open_model_address(self):
        ...
        self.address_input = (
            By.XPATH,
            "//textarea[contains(@class, 'chakra-textarea') and contains(@class, 'css-1msuebi')]",
        )
        self.save_address = (
            By.XPATH,
            "//button[contains(@class, 'chakra-button') and contains(@class, 'css-f2hjvb')]",
        )
