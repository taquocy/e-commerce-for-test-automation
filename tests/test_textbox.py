...
try:
    ...
    full_name_input.send_keys("Phạm Minh Toàn")
    email_input.send_keys("toan@example.com")
    current_address_input.send_keys("123 Đường ABC, TP.HCM")
    ...
    assert "toan@example.com" in driver.page_source, "Email không được hiển thị đúng!"
    assert "123 Đường ABC, TP.HCM" in driver.page_source, "Current Address không được hiển thị đúng!"
