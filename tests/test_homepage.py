...
class HomePageTest(unittest.TestCase):
    ...
    def test_add_to_basket_button_displayed(self):
        ...
        self.assertTrue(self.home_page.is_add_to_basket_button_displayed(
    ...
    def test_add_to_cart_button_displayed(self):
        ...
        self.assertTrue(self.home_page.is_add_to_cart_button_displayed(
    ...
    def test_load_more_button_displayed(self):
        ...
        self.assertTrue(self.home_page.is_load_more_button_displayed(
    ...
    def test_load_more_functionality(self):
        ...
        self.assertTrue(self.home_page.wait_for_load_more_results(
